...
public class LoggingAspect {
    ...
    @Before(value = "execution(* com.kgisl.sb10.service.PersonServiceImpl.*(..))")
    ...
    @After(value = "execution(* com.kgisl.sb10.service.PersonServiceImpl.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.kgisl.sb10.controller.*.*(..))", throwing = "excep")
